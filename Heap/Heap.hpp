...
class Heap {
    ...
    Heap() = default;
    //Constructors
    Heap(function<bool(P, P)> comparator = less<P>()) : comp(comparator) {}

    Heap(int branching_factor, function<bool(P, P)> comparator = less<P>()) 
         : bf(branching_factor), comp(comparator) {}
